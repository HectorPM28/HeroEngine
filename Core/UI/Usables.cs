...
;            }
        ...
        /// <summary>
        /// Fills a List of AHero.
        /// </summary>
        /// <param name="party">An empty list to save the AHero</param>
        ...
        /// <summary>
        /// Creates a AHero depends on the num given
        /// </summary>
        ...
        private static AHero SelectHero(int opt)
        {
            ...
            {
                case 1:
                    Console.WriteLine(UIConfig.Hero.WarScream);
                ...
                default:
                    return new Warrior(NameHero(), Warrior.WarriorBaseHp, 1, 45, "");
            }
        }
